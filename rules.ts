 ...
 * (etalab/normadresse). Rules are grouped by `etape` (step); the rule
 * compiler in `index.ts` parses `etape` with `parseFloat`, so fractional
 * steps such as '1.0', '2.0', '4.0' and '5.0' merge into their integer
 * group (1, 2, 4, 5) and ARE applied by the corresponding pipeline step.
 *
 ...
 */
export const RULES_DATA: Array<CsvRule> = [
